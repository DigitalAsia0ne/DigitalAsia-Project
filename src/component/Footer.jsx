...
function footer() {
  return (
    <footer className="bg-black text-white py-12">
      ...
      {/* Bottom Section */}
      <div className="container mx-auto mt-12 border-t border-white/20 pt-6 text-sm flex flex-col md:flex-row justify-between items-center text-white/60 gap-4 px-4">
